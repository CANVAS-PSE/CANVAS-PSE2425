...
class ProjectList(generics.ListCreateAPIView):
    """Creates a view to list all of the projects of the user who's currently logged in, you can also create a new project."""
    ...
    def perform_create(self, serializer):
        """Save the new project with the current user as the owner."""
        serializer.save(owner=self.request.user)

    def get_queryset(self):
        """Return the list of projects for the currently authenticated user."""
